...
LOGGING = {
    ...
    'loggers': {
        'django': {
            'handlers': ['console'],
            'level': os.getenv('DJANGO_LOG_LEVEL', 'INFO' if DEBUG else 'ERROR'),
            'propagate': False,
        },
    },
}
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Online Detection Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "OnlineDetectionAdmin",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Online Detection",
    ...
    "welcome_sign": "Welcome to the \"Online Detection\"  Admin panel",

    # Copyright on the footer
    "copyright": "Online Detection",
